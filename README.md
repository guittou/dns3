...
| `APP_LOG_PATH` | Chemin du fichier de log applicatif (optionnel) |
...
- **Authentification** : Tentatives de connexion (source, utilisateur, méthode, résultat), récupération des groupes AD/LDAP
